...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Attachment Bottom Sheet"),
      ),
                          ...
                          Container(
                            ...
                            child: ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  }, index , context , (File file , int index){
                                    setState((){
                                      media[index] = {
                                        "type" : "image" , 
                                        "file" : file
...
Widget attachmentWidget(
    Map<String, dynamic> attachment, Function deleteAttachment, int index , BuildContext context , Function editImage) {
                                  ...
                                  : attachment["extension"] == "word"
                                      ...
                                      : attachment["extension"] == "excel"
                                          ...
                                          : attachment["extension"] ==
                                              ...
                                              : attachment["extension"] == "image" ? Align(
                                                child: ClipRRect(
                                                  borderRadius: BorderRadius.circular(10),
                                                  child: Image.file(attachment["file"], width: 100, fit: BoxFit.cover,)),
                                              ) : Container(),
                            )
                          : Container(),
          Align(
          ...
          attachment["type"] == "image"
              ? GestureDetector(
                onTap: () async {
                  ...
                  print("DATA : $data");
                  var editedImage = await Navigator.push(context, MaterialPageRoute(builder: (context){
                    return ImageEditor(image: data,);
                  }));
...
Future<File> fromUint8ListToImage(editedImage) async  {
  ...
  final file = await new File("${tempDir.path}/$imagePath").create();
